  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard"
        subTitle="Monitor over all your bookings and cars.Also manage your overall platform performance and analytics" />
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        {dashboardCards.map((card, index) => (
          <div key={index} className='flex items-center gap-2 p-4 justify-between border border-borderColor rounded-md'>
            <div>
