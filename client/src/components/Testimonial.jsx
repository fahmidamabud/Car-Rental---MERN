...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            <Title title="What our customers are saying" subTitle="Discover what our satisfied customers have to say about our service.
            Our testimonials are a testament to the quality of our products and services."/>
