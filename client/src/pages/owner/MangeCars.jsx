...
const MangeCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="Manage and view all your car rental bookings in one place.Remove and add new cars"/>
          ...
          <table className='w-full border-collapse text-left text-sm text-gray-600'>
            <thead className=' text-gray-500'>
              <tr>
                 ...
                 <th className='p-3 font-medium max-,d:hidden'>Category</th>
