...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div  className={`flex items-center justify-between px-6 py-4 md:px-16 lg:px-24 xl:px-32 text-gray-600 relative
    border-b border-borderColor transition-all
    ...
    `} >
        ...
        ${open ? 'max-sm:translate-x-0' : 'max-sm:translate-x-full'}`} >
             ...
             <div className='hidden lg:flex items-center gap-2 text-sm border border-borderColor rounded-full px-3 max-w-56' >
            ...
            <img src={assets.search_icon} alt="search" />
             ...
             <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
                ...
                <button onClick={() => setShowLogin(true)} className='cursor-pointer px-8 py-2 bg-primary hover:bg-primaryDull transition-all text-white rounded-lg'>Login</button>
             </div>
        </div>
